...
| Affordances | `docs/affordances.md` | `spec/shacl/affordance.ttl`, `spec/shacl/emit-plan-params.ttl` | `examples/golden-path/context-fragment.json` | `tests/negative/README.md` |
