...
Validation helper: `python scripts/validate_examples.py`.
...
Implementation starter lives in `src/broker/app.py`.
...
Validation helper: `python scripts/validate_negative_cases.py`.
